...
class GetTasksQueryHandler implements QueryHandlerInterface
{
    ...
    public function __invoke(GetTasksQuery $command): GetTasksResponse
    {
        $tasks = $this->getTasks();
        $tasks = $this->tasksFormat($tasks);

        return GetTasksResponse::fromArray($tasks);
    }
