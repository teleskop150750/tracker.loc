...
class GetGanttAssignedTasksForMeQueryHandler implements QueryHandlerInterface
{
    ...
    public function __invoke(GetGanttAssignedTasksForMeQuery $command): GetGanttAssignedTasksForMeResponse
    {
        ...
        return GetGanttAssignedTasksForMeResponse::fromArray($tasks);
    }
}
