...
class GetFolderMeTasksQueryHandler implements QueryHandlerInterface
{
    ...
    public function __invoke(GetFolderMeTasksQuery $command): GetFolderMeTasksResponse
    {
        ...
        return GetFolderMeTasksResponse::fromArray($folders);
    }
    ...
    private function filterFolders(array $folders): array
    {
        return Arr::where($folders, static function (array $folder) {
            return 'USER' === $folder['type'] || 'ROOT' === $folder['type'];
        });
    }
