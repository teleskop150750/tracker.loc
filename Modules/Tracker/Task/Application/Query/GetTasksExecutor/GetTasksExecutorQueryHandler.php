...
class GetTasksExecutorQueryHandler implements QueryHandlerInterface
{
    ...
    public function __invoke(GetTasksExecutorQuery $command): GetTasksExecutorResponse
    {
        $tasks = $this->getTasks();
        $tasks = $this->tasksFormat($tasks);

        return GetTasksExecutorResponse::fromArray($tasks);
    }
