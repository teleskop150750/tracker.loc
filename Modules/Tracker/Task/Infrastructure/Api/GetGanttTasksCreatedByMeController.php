...
use Modules\Tracker\Task\Application\Query\GetGanttTasksCreatedByMe\GetGanttTasksCreatedByMeQuery;
use Symfony\Component\HttpFoundation\JsonResponse;

class GetGanttTasksCreatedByMeController extends ApiController
{
    public function __invoke(Request $request, EntityManagerInterface $em): JsonResponse
    {
        ...
        try {
            $tasks = $this->ask(GetGanttTasksCreatedByMeQuery::make());
            $conn->commit();
