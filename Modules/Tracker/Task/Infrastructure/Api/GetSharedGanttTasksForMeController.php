...
use Modules\Tracker\Task\Application\Query\GetSharedGanttTasksForMe\GetSharedGanttTasksForMeQuery;
use Symfony\Component\HttpFoundation\JsonResponse;

class GetSharedGanttTasksForMeController extends ApiController
{
    public function __invoke(Request $request, EntityManagerInterface $em): JsonResponse
    {
        ...
        try {
            $folder = $this->ask(GetSharedGanttTasksForMeQuery::make());
            $conn->commit();
