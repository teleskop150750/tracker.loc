...
use Modules\Tracker\Task\Application\Query\GetAssignedTasksForMe\GetAssignedTasksForMeQuery;
use Symfony\Component\HttpFoundation\JsonResponse;

class GetAssignedTasksForMeController extends ApiController
{
    public function __invoke(EntityManagerInterface $em): JsonResponse
    {
        ...
        try {
            $folders = $this->ask(GetAssignedTasksForMeQuery::make());
            $conn->commit();
