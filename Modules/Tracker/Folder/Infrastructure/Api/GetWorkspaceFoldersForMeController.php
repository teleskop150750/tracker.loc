...
use Modules\Tracker\Folder\Application\Query\GetWorkspaceFoldersForMe\GetWorkspaceFoldersForMeQuery;

class GetWorkspaceFoldersForMeController extends ApiController
{
    public function __invoke(EntityManagerInterface $em): JsonResponse
    {
        ...
        try {
            $folders = $this->ask(GetWorkspaceFoldersForMeQuery::make());
            $conn->commit();
